// Auto-generated: HTML content embedded at build time
  ...
  <div class="container">
    ...
    <div class="ai-advice-section" id="aiAdviceSection">
      <h3>
        ...
        <button class="close-btn" id="btnCloseAI" aria-label="Close">×</button>
      </h3>
    ...
    const renderStatsOverview = (data) => {
      ...
      statsContainer.innerHTML = \`
        <div class="stat-card">
          ...
          <div class="change">↑ Active feedback count</div>
        </div>
        <div class="stat-card">
          <h3>Unique Themes</h3>
          <div class="value">\${(data.byTheme || []).length}</div>
          <div class="change">↑ Identified themes</div>
        </div>
        <div class="stat-card">
          <h3>Avg. Urgency</h3>
          <div class="value">\${avgUrgency}</div>
          <div class="change">\${urgencyCounts.critical > 0 ? \`⚠ \${urgencyCounts.critical} critical issues\` : '↓ No critical issues'}</div>
        </div>
        <div class="stat-card">
          <h3>Sentiment Score</h3>
          <div class="value">\${sentimentScore}%</div>
          <div class="change">↑ \${positiveCount} positive feedbacks</div>
        </div>
      \`;
    };
      ...
      chartsGrid.innerHTML = \`
        ...
        <div class="chart-card">
          ...
          <h3>Feedback by Theme</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartTheme', 'Feedback by Theme', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
        ...
        <div class="chart-card">
          ...
          <h3>Feedback by Platform</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartPlatform', 'Feedback by Platform', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        <div class="chart-card">
          ...
          <h3>Feedback by Country</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartCountry', 'Feedback by Country', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        <div class="chart-card">
          ...
          <h3>Feedback by Product</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartProduct', 'Feedback by Product', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        <div class="chart-card full-width">
          ...
          <h3>Feedback Over Time</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartTime', 'Feedback Over Time', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
        ...
        <div class="chart-card">
          ...
          <h3>Sentiment Analysis</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartSentiment', 'Sentiment Analysis', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        <div class="chart-card">
          ...
          <h3>Urgency Levels</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartUrgency', 'Urgency Levels', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        <div class="chart-card">
          ...
          <h3>Value Assessment</h3>
            <div class="chart-actions">
              <button class="btn-icon" onclick="copyChart('chartValue', 'Value Assessment', event)" title="Copy chart as image">📋</button>
            </div>
          </div>
          <div class="chart-container">
        ...
        if (aiResult.fallback) {
          adviceHTML = \`
            <div class="advice-item" style="background: #FFF3E0; padding: 12px; border-radius: 6px; margin-bottom: 12px;">
              <strong style="color: #F6821F;">⚠️ Using Fallback Recommendations</strong>
      ...
      menu.innerHTML = \`
        <div class="share-menu-content">
          <div class="share-menu-header">
            <h4>Share Link</h4>
            <button class="share-menu-close" onclick="this.closest('.share-menu').remove()">×</button>
          </div>
          <div class="share-menu-url">
            <input type="text" value="\${url}" readonly id="shareUrlInput">
            <button class="btn-copy-url" onclick="copyShareUrl('\${url.replace(/'/g, "\\\\'")}')">📋 Copy</button>
          </div>
